...
@section('title', 'Nueva Ciudad - SFA')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-plus-circle me-2" style="color: #166866;"></i>Nueva Ciudad</h2>
                    ...
                    <form method="POST" action="{{ route('ciudades.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('codigo_ciudad') is-invalid @enderror" 
                                   id="codigo_ciudad" name="codigo_ciudad" value="{{ old('codigo_ciudad') }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('descripcion_ciudad') is-invalid @enderror" 
                                   id="descripcion_ciudad" name="descripcion_ciudad" value="{{ old('descripcion_ciudad') }}" 
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Guardar Ciudad
                            </button>
